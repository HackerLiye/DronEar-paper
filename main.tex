...
\begin{figure*}[t]
	...
	\subfigure[Original spectrogram]{
		...
		\includegraphics[width=0.3\textwidth]{pics/original_formants.jpg}}
	\subfigure[Locations of formants]{
		\label{processed_formants}
		\includegraphics[width=0.3\textwidth]{pics/processed_formants.jpg}}
	\subfigure[Unioned formants]{
		\label{final_formants}
		\includegraphics[width=0.3\textwidth]{pics/final_formants.jpg}}
